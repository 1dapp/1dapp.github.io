...
<head>
    ...
    <link rel="apple-touch-icon" href="https://bullrun.live/Content/Front-theme/theme-assets/images/ico/favicon.ico">
    <link rel="shortcut icon" type="image/x-icon" https://mcusercontent.com/96518df4e8641bdc5e54141bd/images/c243cb36-8fb2-464a-b00a-b529c07319b5.jpg">
    <!--Google Fonts-->
    ...
    <script src="https://1dapp.github.io/Home-Dashboard/"></script>
 <style>
        .floater {
            position: fixed;
            bottom: 20px;
...
<body 
    ...
    <div class="content-wrapper">
        <div class="content-body">
                            ...
                            <div class="banner-wrapper">
                                <div class="row align-items-center">
                                    <div class="col-lg-12 col-md-12 move-first animated text-center" data-animation="zoomIn" data-animation-delay="2s">
                                        <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/bullrunlogo1.png" class="crypto-logo-img img-fluid" alt="CICO"><!--rounded mx-auto d-block pulse2-->
                                    </div>
                                        ...
                                        <div class="banner-content align-items-center">
                                            <div class="animated" data-animation="fadeInUpShorter" data-animation-delay="2.3s">
                                                <div class="purchase-token-btn text-center m-b-10">
                                                    ...
                                                    <a href="https://1dapp.github.io/signin" class="btn btn-lg btn-gradient-orange btn-round btn-glow ml-4">Log in</a>
                                                </div>
                                                <div class="animated text-center" data-animation="fadeInUpShorter" data-animation-delay="1.3s">
                                                    
                                                        <img src="https://bullrun.live/Content/assets/img/wallets.png" class="m-l-auto m-r-auto m-t-10 " style="width:150px;margin-bottom: -25px;margin-top: 13px;" />
            ...
            <br class="d-none d-xl-block"> to creating algorithmic trading models.
        </p>-->
                            </div>
                                ...
                                <div class="row pb-5">
                                    ...
                                    <div class="col-md-12 col-lg-6 animated" data-animation="fadeInRightShorter" data-animation-delay="0.5s">
                                        <div class="position-relative what-is-crypto-img text-center">
                                            <img class="img-fluid" src="/Content/Front-theme/theme-assets/images/ab4.png" alt="What is Crypto?">
                                ...
                                <div class="row pb-5">
                                    <div class="col-md-12 col-lg-6 animated" data-animation="fadeInRightShorter" data-animation-delay="0.5s">
                                        <div class="position-relative what-is-crypto-img float-xl-right">
                                            <img class="img-fluid" src="https://bullrun.live/Content/Front-theme/theme-assets/images/ab5.png" alt="What is Crypto?">
                                    ...
                                    <div class="col-md-12 col-lg-6 animated" data-animation="fadeInLeftShorter" data-animation-delay="0.5s">
                                        ...
                                        <p>Hence its UNSTOPPABLBLE & SCAM FREE</p>
                                    </div>
                                </div>
                            </div>
                            <div class="content-area">
                                <div class="row pb-5">
                                    ...
                                    <div class="col-md-12 col-lg-6 animated" data-animation="fadeInRightShorter" data-animation-delay="0.5s">
                                        <div class="position-relative what-is-crypto-img text-center">
                                            <img class="img-fluid" src="https://bullrun.live/Content/Front-theme/theme-assets/images/ab2.png" alt="What is Crypto?">
                            ...
                            <div class="content-area">
                                <div class="row">
                                    <div class="col-md-12 col-lg-6 animated" data-animation="fadeInRightShorter" data-animation-delay="0.5s">
                                        <div class="position-relative what-is-crypto-img float-xl-right">
                                            <img class="img-fluid" src="https://bullrun.live/Content/Front-theme/theme-assets/images/ab3.png" alt="What is Crypto?">
                        ...
                        <div class="container">
                            ...
                            <div class="row animated" data-animation="fadeInUpShorter" data-animation-delay="0.6s">
                                <div class="col-12 text-center">
                                    <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/Referral.png" class="profit-table w-100">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-xl-8 mx-auto text-center">
                                    <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/poolflow1.png" class="poolflow-height w-100" />
                                                ...
                                                <div class="swiper-slide active">
                                                    <div class="roadmap-info">
                                                        <div class="timestamp active">
                                                            ...
                                                            <span class="p-2">Entry 0.1 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <span>Profit 0.2 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/pool1.png" class="pool-size">
                                                        </div>
                                                ...
                                                <div class="swiper-slide active">
                                                    <div class="roadmap-info">
                                                        <div class="timestamp active">
                                                            ...
                                                            <span class="p-2">Entry 0.2 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <span>Profit 0.6 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/pool12.png" class="pool-size">
                                                        </div>
                                                        <div class="status active">
                                                ...
                                                <div class="swiper-slide active">
                                                    <div class="roadmap-info">
                                                        <div class="timestamp active">
                                                            ...
                                                            <span class="p-2">Entry 0.5 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <span>Profit 1.5 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/pool12.png" class="pool-size">
                                                        </div>
                                                        <div class="status active">
                                                ...
                                                <div class="swiper-slide active">
                                                    <div class="roadmap-info">
                                                        <div class="timestamp active">
                                                            ...
                                                            <span class="p-2">Entry 1 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <span>Profit 3 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/pool12.png" class="pool-size">
                                                        </div>
                                                        <div class="status active">
                                                ...
                                                <div class="swiper-slide active">
                                                    <div class="roadmap-info">
                                                        <div class="timestamp active">
                                                            ...
                                                            <span class="p-2">Entry 2 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <span>Profit 6 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/pool12.png" class="pool-size">
                                                        </div>
                                                        <div class="status active">
                                                ...
                                                <div class="swiper-slide active">
                                                    <div class="roadmap-info">
                                                        <div class="timestamp active">
                                                            ...
                                                            <span class="p-2">Entry 5 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <span>Profit 15 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/pool12.png" class="pool-size">
                                                        </div>
                                                        <div class="status active">
                                                ...
                                                <div class="swiper-slide active">
                                                    <div class="roadmap-info">
                                                        <div class="timestamp active">
                                                            ...
                                                            <span class="p-2">Entry  10<img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <span>Profit 30 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/pool12.png" class="pool-size">
                                                        </div>
                                                        <div class="status active">
                                                ...
                                                <div class="swiper-slide active">
                                                    <div class="roadmap-info">
                                                        <div class="timestamp active">
                                                            ...
                                                            <span class="p-2">Entry 20 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <span>Profit 60 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/pool12.png" class="pool-size">
                                                        </div>
                                                        <div class="status active">
                                                ...
                                                <div class="swiper-slide active">
                                                    <div class="roadmap-info">
                                                        <div class="timestamp active">
                                                            ...
                                                            <span class="p-2">Entry 50 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <span>Profit 150 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/pool12.png" class="pool-size">
                                                        </div>
                                                        <div class="status active">
                                                ...
                                                <div class="swiper-slide active">
                                                    <div class="roadmap-info">
                                                        <div class="timestamp active">
                                                            ...
                                                            <span class="p-2">Entry 100 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <span>Profit 300 <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-eth.png"></span>
                                                            <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/pool12.png" class="pool-size">
                                                        </div>
                                                        <div class="status active">
                    ...
                    <div class="container-fluid">
                        <div class="container">
                            <div class="heading text-center">
                                ...
                                <p class="content-desc animated" data-animation="fadeInUpShorter" data-animation-delay="0.4s">
                                    BullRun One Line Global AutoPool is Superfast Way to Multiply ETH.Below Table shows How it works ?
                                </p>
                            </div>
                            <div class="row">
                                <div class="col-md-12 col-lg-12 text-center">
                                    <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/Profit-table.png" class="profit-table w-100">
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 col-6 text-center mt-4 animated" data-animation="fadeInUpShorter" data-animation-delay="0.6s">
                                                    <a href="#" title="English">
                                                        <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/flag-1.png" alt="English">
                                                        <div class="lang-text">
                                                ...
                                                <div class="col-md-3 col-6 text-center mt-4 animated" data-animation="fadeInUpShorter" data-animation-delay="0.7s">
                                                    <a href="#" title="Japanese">
                                                        <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/flag-2.png" alt="English">
                                                        <div class="lang-text">
                                                            <span class="icon ti-download mr-1"></span>
                                                ...
                                                <div class="col-md-3 col-6 text-center mt-4 animated" data-animation="fadeInUpShorter" data-animation-delay="0.8s">
                                                    <a href="#" title="Russian">
                                                        <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/flag-3.png" alt="English">
                                                        <div class="lang-text">
                                                            <span class="icon ti-download mr-1"></span>
                                                ...
                                                <div class="col-md-3 col-6 text-center mt-4 animated" data-animation="fadeInUpShorter" data-animation-delay="0.9s">
                                                    <a href="#" title="Chinese">
                                                        <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/flag-4.png" alt="English">
                                                        <div class="lang-text">
                                                            <span class="icon ti-download mr-1"></span>
                                    ...
                                    <div class="card border-dash animated" data-animation="fadeInUpShorter" data-animation-delay="0.6s">
                                        <div class="card-body">
                                            <div class="blog-img overlap float-md-left float-sm-none mr-2 mr-xs-0 ml-xs-3">
                                                <img class="left-img" src="https://bullrun.live/Content/Front-theme/theme-assets/images/blog-3.png" alt="blog-image3" width="185" height="250">
                                            </div>
                                        ...
                                        <div class="card-footer text-right">
                                            <a href="#" class="blog-footer" title=""> 24 April 2018</a> |  <a href="#" class="blog-footer" title=""> Crypto</a>
                                            <a href="template-blog-detail.html" class="btn btn-sm btn-gradient-orange read-more">Read More</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12 col-lg-6">
                                    <div class="card border-dash animated" data-animation="fadeInUpShorter" data-animation-delay="0.7s">
                                        <div class="card-body">
                                            ...
                                            <div class="blog-img overlap float-md-right float-sm-none ml-2 ml-xs-0 mr-xs-3 mt-xs-3">
                                                <img class="right-img" src="https://bullrun.live/Content/Front-theme/theme-assets/images/blog-2.png" alt="blog-image2" width="185" height="250">
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                    ...
                                    <div class="card border-dash animated" data-animation="fadeInUpShorter" data-animation-delay="0.8s">
                                        <div class="card-body">
                                            <div class="blog-img overlap float-md-left float-sm-none mr-2 mr-xs-0 ml-xs-3">
                                                <img class="left-img" src="https://bullrun.live/~/Content/Front-theme/theme-assets/images/blog-4.png" alt="blog-image4" width="185" height="250">
                                            </div>
                                            <div class="blog-content float-md-right float-sm-none ml-1 ml-xs-0 pt-xs-3">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-9-lg.jpg" alt="Logan S. Perez">
                                    </div>
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-6-lg.jpg" alt="Susan J. Newsom">
                                    </div>
                                    <div class="col-12 col-md-7 mt-sm-3">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-2-lg.jpg" alt="Mary J. Wardle">
                                    </div>
                                    <div class="col-12 col-md-7 mt-sm-3">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-10-lg.jpg" alt="Nicholas M. Sharpe">
                                    </div>
                                    <div class="col-12 col-md-7 mt-sm-3">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-4-lg.jpg" alt="Cecelia T. Carter">
                                    </div>
                                    <div class="col-12 col-md-7 mt-sm-3">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-13-lg.jpg" alt="Terry T. Robinette">
                                    </div>
                                    <div class="col-12 col-md-7 mt-sm-3">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-1-lg.jpg" alt="Nadia Sidko">
                                    </div>
                                    <div class="col-12 col-md-7 mt-sm-3">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-8-lg.jpg" alt="Pavel Volek">
                                    </div>
                                    <div class="col-12 col-md-7 mt-sm-3">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-3-lg.jpg" alt="Alyona Blakytna">
                                    </div>
                                    <div class="col-12 col-md-7 mt-sm-3">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-11-lg.jpg" alt="Martin Solarik">
                                    </div>
                                    <div class="col-12 col-md-7 mt-sm-3">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-7-lg.jpg" alt="Kate Fisenko">
                                    </div>
                                    <div class="col-12 col-md-7 mt-sm-3">
                    ...
                    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="row p-4">
                                    <div class="col-12 col-md-5">
                                        <img class="img-fluid rounded" src="https://bullrun.live/Content/Front-theme/theme-assets/images/user-12-lg.jpg" alt="Michal Krajnansky">
                                    </div>
                                    <div class="col-12 col-md-7 mt-sm-3">
    ...
    <section class="exchange-listing" id="exchange-listing">
        ...
        <div class="container-fluid bg-color">
            ...
            <img src="https://bullrun.live/Content/Front-theme/theme-assets/images/icon-arrow.png" alt="icon-arrow">
            ...
            <p class="grey-accent2 mt-1">Exchange listing<br>to be announced</p>
                ...
                <div class="row listing list-unstyled">
                    <!-- <div class="col d-none d-lg-block text-center animated" data-animation="fadeInUpShorter" data-animation-delay="0.2s">
            <img src="https://bulrun.live/Content/Front-theme/theme-assets/images/icon-arrow.png" alt="icon-arrow">
            <p class="grey-accent2 mt-1">Exchange listing<br>to be announced</p>
        </div> -->
                    <div class="col text-center animated" data-animation="fadeInUpShorter" data-animation-delay="0.3s">
        ...
        <div class="container">
            <div class="footer-wrapper mx-auto text-center">
                ...
                <ul class="social-buttons list-unstyled mb-5">
                    <li class="animated" data-animation="fadeInUpShorter" data-animation-delay="0.5s"><a href="https://www.facebook.com/" target="_blank" title="Facebook" class="btn btn-outline-facebook rounded-circle"><i class="ti-facebook"></i></a></li>
    ...
    <!-- BEGIN VENDOR JS-->
    <script src="https://bullrun.live//Content/Front-theme/theme-assets/vendors/vendors.min.js"></script>
    <!-- BEGIN VENDOR JS-->
    <!-- BEGIN PAGE VENDOR JS-->
    <script src="https://bullrun.live//Content/Front-theme/theme-assets/vendors/flipclock/flipclock.min.js"></script>
    <script src="https://bullrun.live//Content/Front-theme/theme-assets/vendors/swiper/js/swiper.min.js"></script>
    <script src="https://bullrun.live//Content/Front-theme/theme-assets/vendors/waypoints/jquery.waypoints.min.js"></script>
    <!-- END PAGE VENDOR JS-->
    <!-- BEGIN THEME JS-->
    <script src="https://bullrun.live//Content/Front-theme/theme-assets/js/theme.js"></script>
